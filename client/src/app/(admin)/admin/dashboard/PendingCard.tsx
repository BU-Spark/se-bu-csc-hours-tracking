...
export default function PendingCard({name, year, category, hours, date, profilePic} : PendingHourCardProps){
    return(
        <Card 
            style={{ 
                marginTop: "1.25rem",  
            ...
            <div style={{ display: 'flex', flexDirection: 'row', marginTop: "0.1875rem" }}> 
                ...
                <div style={{ display: 'flex', flexDirection: 'column', marginLeft: "0.625rem" }}>  
                    ...
                    <span style={{ fontSize: "clamp(0.656rem, 1.3vw, 0.75rem)", color:'white' }}>{year}</span> 
                </div>
            </div>}
            styles={{
                body: {
